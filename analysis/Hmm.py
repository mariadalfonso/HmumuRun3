...
#          .Define("Muon2_pt","Muon_pt[goodMuons][1]")
          ...
          .Define("HiggsCandCorrMass","MinvCorr(Muon_bsConstrainedPt[goodMuons], Muon_eta[goodMuons], Muon_phi[goodMuons], Muon_mass[goodMuons], FsrPhoton_pt[goodFRSphoton], FsrPhoton_eta[goodFRSphoton],FsrPhoton_phi[goodFRSphoton],0)")
