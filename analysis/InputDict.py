...
def BuildDict(year):
    ...
    thisdict = {
        10: (findDIR(pathScratch("/VBF*Hto2Mu_*M-125_TuneCP5*_13p6TeV_powheg-pythia8")),xsecRun3['VBFH']*BRHmm),
        11: (findDIR(pathScratch("/GluGlu*Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['ggH']*BRHmm),   # reweighting for NNLO PS should be done
        12: (findDIR(pathScratch("/WminusH*Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg*-pythia8")),xsecRun3['Wm']*BRHmm),
        13: (findDIR(pathScratch("/WplusH*Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg*-pythia8")),xsecRun3['Wp']*BRHmm),
        14: (findDIR(pathScratch("/ZH*Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg*-pythia8")),xsecRun3['ZH']*BRHmm),
        15: (findDIR(pathScratch("/TTH*Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['TTH']*BRHmm),
#        16: (findDIR(path("/GluGluZH-Zto2L-Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['ggZH']*0.00022*0.10),  not sure about the xsection 
        17: (findDIR(path("/BBH-Hto2Mu_*M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['bbH']*BRHmm),
        ##
        20: (findDIR(path("/VBF*HtoZG*to2L*M-125_TuneCP5*_13p6TeV_powheg-pythia8")),xsecRun3['VBFH']*BRHZg),
        21: (findDIR(path("/GluGlu*HtoZG*to2L*M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['ggH']*BRHZg),
        22: (findDIR(path("/WminusH*HtoZG*to2L*M-125_TuneCP5_13p6TeV_powheg*-pythia8")),xsecRun3['Wm']*BRHZg),
        23: (findDIR(path("/WplusH*HtoZG*to2L*M-125_TuneCP5_13p6TeV_powheg*-pythia8")),xsecRun3['Wp']*BRHZg),
        24: (findDIR(path("/ZH*HtoZGto2LG_*M-125_TuneCP5_13p6TeV_powheg*-pythia8")),xsecRun3['ZH']*BRHZg),
        25: (findDIR(path("/ttHtoZG_Zto2L_M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['TTH']*BRHZg),
        26: (findDIR(path("/TTH-HtoZGto2LG_Par-M-125_TuneCP5_13p6TeV_powheg-pythia8")),xsecRun3['TTH']*BRHZg),
        ##
        30: (findDIR(path("/VBF*Hto2Wto2L2Nu*M-125_TuneCP5*_13p6TeV_powheg-jhugen-pythia8")),xsecRun3['VBFH']*BRH2W2L),
        31: (findDIR(path("/GluGlu*Hto2Wto2L2Nu*M-125_TuneCP5_13p6TeV_powheg-jhugen-pythia8")),xsecRun3['ggH']*BRH2W2L),
        32: (findDIR(path("/WminusH*Wto2Q-Hto2Wto2L2Nu*M-125_TuneCP5_13p6TeV_powheg*-jhugen-pythia8")),xsecRun3['Wm']*BRH2W2L*(1-0.325)),
        33: (findDIR(path("/WminusH*WtoLNu-Hto2Wto2L2Nu*M-125_TuneCP5_13p6TeV_powheg*-jhugen-pythia8")),xsecRun3['Wm']*BRH2W2L*0.325),
        34: (findDIR(path("/WplusH*Wto2Q_Hto2Wto2L2Nu*M-125_TuneCP5_13p6TeV_powheg*-jhugen-pythia8")),xsecRun3['Wp']*BRH2W2L*(1-0.325)),
        35: (findDIR(path("/WplusH*WtoLNu-Hto2Wto2L2Nu*M-125_TuneCP5_13p6TeV_powheg*-jhugen-pythia8")),xsecRun3['Wp']*BRH2W2L*0.325),
        36: (findDIR(path("/ZH*Zto2Q-Hto2Wto2L2Nu_*M-125_TuneCP5_13p6TeV_powheg*-jhugen-pythia8")),xsecRun3['ZH']*BRH2W2L*0.70),
        37: (findDIR(path("/ZH*Zto2L-Hto2Wto2L2Nu_*M-125_TuneCP5_13p6TeV_powheg*-jhugen-pythia8")),xsecRun3['ZH']*BRH2W2L*0.10),
#        38: (findDIR(path("/GluGluZH-Zto2L-Hto2Wto2L2Nu_*M-125_TuneCP5_13p6TeV_powhegMINLO-jhugen-pythia8")),xsecRun3['ggZH']*BRH2W2L*0.10), not sure about the xsection 
#        39: (findDIR(path("/GluGluZH-Zto2Q-Hto2Wto2L2Nu_*M-125_TuneCP5_13p6TeV_powhegMINLO-jhugen-pythia8")),xsecRun3['ggZH']*BRH2W2L*0.70), not sure about the xsection 
        ## DY-QCD
        # 102 is now free
...
#        103: (findDIR(path("/DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8")),xsecRun3['Z']*(1./3)),
        ...
        98:  (findDIR(path("/EWK*2Mu2J_*MLL-105to160_TuneCH3_13p6TeV_madgraph-herwig7")),0.0527*1000), #xsecRun3['EWKZ']/120.), # added 120. empirical scaling from the DYQCD (# 0.0527)
        # 0.79 
        ## TTBAR
        ...
        #TbarBQ t-channel 4FS TuneCP5 13p6TeV powheg-madspin-pythia8\
        #TBbarQ t-channel 4FS TuneCP5 13p6TeV powheg-madspin-pythia8
        #TbarWplustoLNu2Q TuneCP5 13p6TeV powheg-pythia8
        #TWminustoLNu2Q TuneCP5 13p6TeV powheg-pythia8
        ## DI/TRI- BOSON
        ...
        #
        #/TTZH TuneCP5 13p6TeV madgraph-pythia8/
        #/TTWH TuneCP5 13p6TeV madgraph-pythia8/
        #/TTZH TuneCP5 13p6TeV madgraph-pythia8
        #THQ ctcvcp HIncl M-125 4FS TuneCP5 13p6TeV madgraph-pythia8
        #THW ctcvcp HIncl M-125 5FS TuneCP5 13p6TeV madgraph-pythia8
        #
